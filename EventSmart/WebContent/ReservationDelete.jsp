	...
	<form action="deletereservation" method="post">
		<p>
			<div <c:if test="${messages.disableSubmit}">style="display:none"</c:if>>
				...
				<input id="reservationid" name="reservationid" value="${fn:escapeXml(param.reservationid)}" style="width: 400px" class="form-control" placeholder="ReservationID" required autofocus>
			</div>
		</p>
