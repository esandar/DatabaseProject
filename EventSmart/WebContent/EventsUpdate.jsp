...
<body style="background-image: url(https://images.unsplash.com/photo-1415025148099-17fe74102b28?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=1d2697309ae275b27d03270feb9d73e6&auto=format&fit=crop&w=2736&q=80)">
	...
	<h1  class="h3 mb-3 font-weight-normal" style="color: #e6f7ff">Update Event Description</h1>
	<form action="updateevents" method="post">
		...
		<p>
			<label for="description" class="sr-only">New Description</label>
			<input id="description" name="description" value=""  style="width: 400px" class="form-control" placeholder="New Description" required>
		</p>
		<p>
			<button
          	class="btn btn-outline-light my-2 my-sm-0" 
